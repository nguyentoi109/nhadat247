...
if ( ! class_exists( 'WPEX_Theme_Options' ) ) {
	...
	class WPEX_Theme_Options {
		...
		public static function add_admin_menu() {
			add_menu_page(
				esc_html__( 'Tùy chọn site', 'text-domain' ),
				esc_html__( 'Tùy chọn site', 'text-domain' ),
				'manage_options',
				'theme-settings',
		...
		public static function create_admin_page() { ?>
			...
			<div class="wrap">
				...
				<h1><?php esc_html_e( 'Tùy chọn chung', 'text-domain' ); ?></h1>
				...
				<form method="post" action="options.php">
					...
					<table class="form-table wpex-custom-admin-login-table">
						...
						<tr valign="top">
							<th scope="row"><?php esc_html_e( 'Banner Header', 'text-domain' ); ?></th>
							<td>
								<?php $value = self::get_theme_option( 'input_example' ); ?>
								<input type="file" name="theme_options[input_example]" value="<?php echo esc_attr( $value ); ?>">
							</td>
						</tr>
