<!-- sidebar -->
<aside class="sidebar-1" role="complementary">
<div class="item item-banner" style="position: relative; width: 100%; height: 0; padding-top: 141.4286%; padding-bottom: 48px; box-shadow: 0 2px 8px 0 rgba(63,69,81,0.16);  overflow: hidden;
        ...
        <iframe loading="lazy" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; border: none; padding: 0;margin: 0; z-index: 1;" src="https://www.canva.com/design/DAFJr4QLNpU/view?embed" allowfullscreen="allowfullscreen" allow="fullscreen">
        </iframe>
    </div>
</aside>
<!-- /sidebar -->
