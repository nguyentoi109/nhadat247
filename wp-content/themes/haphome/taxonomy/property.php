	...
	$meta_boxes[] = array(
		...
		// 	),
            ...
            array(
                'id'=> $prefix . 'bedroom',
                'type'=> 'select',
                'name'=> esc_html__('Loại phòng', 'html5blank'),
                'desc' => esc_html__( 'Loại phòng', 'html5blank' ),
                'placeholder'=> esc_html__('Chọn loại phòng', 'html5blank'),
                'options'=> array(
                    '1' => '1 Phòng ngủ',
                    '2' => '2 Phòng ngủ',
                    '3' => '3 Phòng ngủ',
            ...
            array(
                'id'   => $prefix . 'bathroom',
                'type' => 'select',
                'name' => esc_html__('Số nhà vệ sinh', 'html5blank'),
                'desc' => esc_html__('Số nhà vệ sinh', 'html5blank'),
                'placeholder' => esc_html__('Chọn số nhà vệ sinh', 'html5blank'),
                'options' => array(
                    '1' => '1 Nhà vệ sinh',
                    '2' => '2 Nhà vệ sinh',
                    '3' => '3 Nhà vệ sinh',
